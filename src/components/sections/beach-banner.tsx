...
export function BeachBanner() {
  return (
    <section className="relative flex min-h-[78vh] items-start justify-center overflow-hidden">
      <BeachScene />
      ...
      <Reveal className="relative z-10 mx-auto max-w-2xl px-6 pt-24 text-center md:pt-28">
        <p className="eyebrow">Inspired by Florida&rsquo;s Gulf Coast</p>
        <h2 className="mt-5 font-display text-4xl leading-[1.05] text-deepsea md:text-6xl">
