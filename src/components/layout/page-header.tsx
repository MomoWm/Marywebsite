...
export function PageHeader({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute -right-24 -top-16 size-80 rounded-full bg-aqua/25 blur-[110px]" />
      <div className="pointer-events-none absolute -left-20 bottom-0 size-72 rounded-full bg-seafoam/20 blur-[100px]" />
      <div
        className={cn(
